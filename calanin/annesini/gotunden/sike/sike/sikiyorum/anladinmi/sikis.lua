...
local MultiXS = Instance.new("ScreenGui")
...
MultiXS.Name = "MultiXS"
MultiXS.Parent = game.CoreGui
MultiXS.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

main.Name = "main"
main.Parent = MultiXS
main.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
main.Position = UDim2.new(0.0174927115, 0, 0.033623904, 0)
main.Size = UDim2.new(0, 449, 0, 279)

UICorner.Parent = main

UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(161, 161, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(194, 195, 255))}
UIGradient.Parent = main

TextBox.Parent = main
TextBox.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TextBox.BackgroundTransparency = 0.500
TextBox.Position = UDim2.new(0.0340000018, 0, 0.0583333336, 0)
TextBox.Size = UDim2.new(0, 418, 0, 194)
TextBox.Font = Enum.Font.Code
TextBox.PlaceholderText = "Your Script Here Sweetie :P"
TextBox.Text = ""
...
Execute.Position = UDim2.new(0.0334075727, 0, 0.77695173, 0)
...
Circle.Name = "Circle"
Circle.Parent = game.Workspace.MultiXS.main.Execute.RippleEffect
...
Clear.Position = UDim2.new(0.519999981, 0, 0.77700001, 0)
...
Circle_2.Parent = game.Workspace.MultiXS.main.Clear.RippleEffect
...
local function PERDUY_fake_script() -- Execute.Script 
...
coroutine.wrap(PERDUY_fake_script)()
local function EKHOUGV_fake_script() -- Execute.LocalScript 
...
coroutine.wrap(EKHOUGV_fake_script)()
local function PMVCYNT_fake_script() -- Execute.RippleEffect 
	local script = Instance.new('LocalScript', Execute)
	local req = require
	local require = function(obj)
		local fake = fake_module_scripts[obj]
...
coroutine.wrap(PMVCYNT_fake_script)()
local function JRJF_fake_script() -- Clear.LocalScript 
...
coroutine.wrap(JRJF_fake_script)()
local function CXNHRLX_fake_script() -- Clear.RippleEffect 
	local script = Instance.new('LocalScript', Clear)
	local req = require
	local require = function(obj)
		local fake = fake_module_scripts[obj]
...
coroutine.wrap(CXNHRLX_fake_script)()
local function QVXQNQM_fake_script() -- main.Dragify 
...
coroutine.wrap(QVXQNQM_fake_script)()
